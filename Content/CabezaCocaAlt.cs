...
namespace CocacolaMan.Content
{
	...
	// Si se proporciona el valor EquipType.Body aquí, TML esperará que se coloque un archivo X_Body.png junto a la textura principal del elemento.
	[AutoloadEquip(EquipType.Head)]
	public class CabezaCocaAlt : ModItem
	{
